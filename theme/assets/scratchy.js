...
(function () {
  ...
  var GIFT_GUIDA = { name: "Guida P.R.E.D.A.", img: (window.SCRATCHY_IMG&&window.SCRATCHY_IMG['regalo-guida'])||'', gift: true, was: "€19,90" };
  var GIFT_SPED = { name: "Spedizione prioritaria", img: (window.SCRATCHY_IMG&&window.SCRATCHY_IMG['regalo-spedizione'])||'', gift: true };
  var RECEIVE = {
    entry: [
      { name: "2 Scratchy", img: (window.SCRATCHY_IMG&&window.SCRATCHY_IMG['regalo-scratchy'])||'' }
    ],
    hero: [
      { name: "4 Scratchy", img: (window.SCRATCHY_IMG&&window.SCRATCHY_IMG['regalo-scratchy'])||'' },
      GIFT_GUIDA,
      GIFT_SPED
    ],
    value: [
      { name: "6 Scratchy", img: (window.SCRATCHY_IMG&&window.SCRATCHY_IMG['regalo-scratchy'])||'' },
      GIFT_GUIDA,
      GIFT_SPED
    ]
  };
...
(function () {
  ...
  var GIFTS = {
    guida: { name: "Guida P.R.E.D.A.", img: (window.SCRATCHY_IMG&&window.SCRATCHY_IMG['regalo-guida'])||'', was: 19.90 },
    sped:  { name: "Spedizione prioritaria", img: (window.SCRATCHY_IMG&&window.SCRATCHY_IMG['regalo-spedizione'])||'', was: null }
  };
  ...
  function render() {
    ...
    html += '<div class="c-item c-main">' +
      '<img class="c-thumb" src=window.SCRATCHY_IMG['scratchy-1'] alt="Scratchy" />' +
    ...
    fetch("/cart/clear.js", { method: "POST", headers: { "Content-Type": "application/json" } })
      .then(function () {
        return fetch("/cart/add.js", {
          ...
          body: JSON.stringify({ items: [{ id: window.SCRATCHY_VARIANT, quantity: units }] })
        });
      })
