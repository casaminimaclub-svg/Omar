...
(function () {
  ...
  function render() {
    ...
    html += '<div class="c-item c-main">' +
      '<img class="c-thumb" src="https://raw.githack.com/casaminimaclub-svg/Omar/claude/nice-hopper-21wptu/assets/img/scratchy-1.webp" alt="Scratchy" />' +
  ...
  if (checkout) checkout.addEventListener("click", function () {
    ...
    if (state.tier === "hero" || state.tier === "value") items.push({ id: 47965467705529, quantity: 1 });
